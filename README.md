...
Download the [Install_dst.zip](https:wandi-sasl.github.io/Install_dst.zip) file and refer to the **README-n-Install.sh** file for further installation and execution instructions.
